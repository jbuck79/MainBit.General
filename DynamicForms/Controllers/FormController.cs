    ...
    public class FormController : Controller, IController, IUpdateModel
    {
        ...
        public ActionResult Submit(int contentId, string formName)
        {
            ...
            if (form == null)
            {
                ...
                return Json(new { errorMessage = T("The specified form \"{0}\" could not be found.", formName).ToString() });
            }
            ...
            if (!ModelState.IsValid)
            {
                ...
                return Json(new { errorMessage = T("Your data is no valid.") });
            }
            ...
            var messages = _notifier.List().ToList();
            var notifierMessages = _notifier.List() as List<NotifyEntry>;
